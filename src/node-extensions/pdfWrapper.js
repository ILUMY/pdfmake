...
//  };
	...
	this.setBackground = function (obj){
		docDefinition.background = obj;
	}

	this.setFooter = function (obj) {
		docDefinition.footer = obj;
	};

	this.setHeader = function (obj) {
		docDefinition.header = obj;
	};

	this.setPageSize = function (obj) {
		docDefinition.pageSize = obj;
	};

	this.setPageOrientation = function (obj) {
		docDefinition.pageOrientation = obj;
	};

	this.setPageMargins = function (obj) {
		docDefinition.pageMargins = obj;
	};

	this.setDefaultStyle = function (obj) {
